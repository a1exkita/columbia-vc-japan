        ...
        <div className="min-h-screen bg-blue-homeblue w-screen">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-around min-h-screen w-full  animate-fade-in-down">
                <div className="flex flex-col">
                    <h1 className="w-full lg:w-2/5 font-serif bg-lion bg-no-repeat bg-right-top lg:bg-none font-extrabold text-6xl mt-0 p-4 lg:ml-48 lg:mt-40 lg:text-8xl text-white">
                        Connect. Build. Empower.
                    </h1>
                    <p className="font-sans font-light text-white mt-8 mx-8 lg:ml-48 ">
